...
const Home = () => {
  return (
    <div className=" bg-dark text-light flex flex-col justify-center items-center p-0 md:p-20 pb-0  pt-10">
      <div className="w-full flex justify-start md:mt-0  pb-10 md:pl-30 pt-10 md:pt-0 p-10">
        <Hero />
      </div>
      ...
      <div className="w-full flex flex-col md:flex-row md:items-left md:justify-start items-start flex-grow pb-20">
        <div className="w-full flex flex-col space-y-6 md:space-y-0 pt-8 pb-20">
          ...
          <button
            ...
            className=" border-blue-400 border-2 text-white py-2 px-4 rounded-md text-sm font-medium  hover:bg-blue-500 transition cursor-pointer uppercase mt-10 md:w-2/3 w-full md:ml-35"
          >
            <span className=" flex ">
              <img
      ...
      <h2
        className="md:text-6xl text-4xl font-bold uppercase fredoka-variable"
        id="projects"
      >
